...
import { SelectProjectWithOwner, SelectUserWithProject } from "@/db/schema/projects";
...
export default async function ProjectPage({
  ...
  const project = await getProjectBySlugServer(resolvedParams.slug) as SelectProjectWithOwner;
  const user = await getProjectUsersProfileBySlugServer(resolvedParams.slug) as SelectUserWithProject;
  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset>
          ...
          <SignedOut>
            <div className="mb-6">
              <PageBanner
                ...
                bannerTitle={`You are viewing ${project.owner_full_name || "this creator"}'s project.`}
        ...
        >
          <ProjectContent project={project} error={undefined} userProfile={user} />
        </Suspense>
        <FooterSection />
      </SidebarInset>
    </SidebarProvider>
